...
namespace AIO.Champions
{
	...
	internal partial class Kalista
	{
		...
		public double GetQDamage(AIBaseClient target)
		{
			...
			var qBaseDamage = new[] {10, 70, 130, 190, 250}[qLevel - 1]
		...
		public double GetEDamage(AIBaseClient target)
		{
			...
			var eBaseDamage = new[] {20, 30, 40, 50, 60}[eLevel - 1]
				+ 0.6f * UtilityClass.PlayerData.TotalAttackDamage();
			var eStackDamage = new[] {10, 14, 19, 25, 32}[eLevel - 1] +
			                   new[] {0.20f, 0.2375f, 0.275f, 0.3125f, 0.35f}[eLevel - 1] *
							   UtilityClass.PlayerData.TotalAttackDamage();
