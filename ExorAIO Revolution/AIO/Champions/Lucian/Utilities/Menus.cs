...
namespace AIO.Champions
{
    ...
    internal partial class Lucian
    {
        ...
        public void Menus()
        {
	        ...
	        /// </summary>
	        MenuClass.Root.Add(new MenuList("pattern", "Combo Pattern", new[] { "E->Q->W", "Q->E->W", "E->W->Q", "W->E->Q" }));
	        ...
	        MenuClass.E = new Menu("e", "Use E to:");
	        {
		        ...
		        MenuClass.E2 = new Menu("customization", "Customization:");
		        {
					...
					if (count > 1)
			        {
				        MenuClass.E2.Add(new MenuSliderBool("erangecheck", "Don't E if X enemies in range from pos", true, count >= 3 ? 3 : count, 2, count));
			        }
			        else
			        {
				        MenuClass.E2.Add(new MenuSeperator("exseparator", "Don't E if >= / No enemies found, no need for a position range check."));
			        }
