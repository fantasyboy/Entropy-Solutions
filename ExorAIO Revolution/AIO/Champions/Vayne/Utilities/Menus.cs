		...
		public void Menus()
		{
			...
			MenuClass.Q = new Menu("q", "Use Q to:");
			{
				...
				MenuClass.Q2 = new Menu("customization", "Customization:");
				{
					...
					{
						MenuClass.Q2.Add(new MenuSeperator("exseparator",
							"Don't Q if pos has >= / No enemies found, no need for a position range check."));
					}
			...
			MenuClass.Miscellaneous = new Menu("miscellaneous", "Miscellaneous");
			{
				...
				{
					MenuClass.Miscellaneous.Add(new MenuSeperator("exseparator",
						"No enemies found, no need for stealth slider check."));
				}
			}
