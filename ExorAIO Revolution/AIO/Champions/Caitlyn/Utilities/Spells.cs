	...
	internal partial class Caitlyn
	{
		...
		public void Spells()
		{
			...
			SpellClass.R = new Spell(SpellSlot.R,
				1500f + 500f * UtilityClass.Player.Spellbook.GetSpell(SpellSlot.R).Level);

			SpellClass.Q.SetSkillshot(1f, 60f, 2200f, SkillshotType.Line, false);
			SpellClass.Q2.SetSkillshot(SpellClass.Q.Delay, SpellClass.Q.Width * 2, SpellClass.Q.Speed,
				SpellClass.Q.Type, SpellClass.Q.Collision);
